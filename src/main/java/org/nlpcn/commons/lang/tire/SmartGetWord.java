...
public class SmartGetWord<T> {
	...
	private final SmartForest<T> forest;
	private char[] chars;
	private String str;
	private int tempOffe = 0;
	private T param;
	private SmartForest<T> branch;

	public SmartGetWord(final SmartForest<T> forest, final String content) {
		this(forest, content.toCharArray());
	}

	public SmartGetWord(final SmartForest<T> forest, final char[] chars) {
		this.chars = chars;
		this.forest = forest;
		this.branch = forest;
	}
